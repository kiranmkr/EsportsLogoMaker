package com.example.esportslogomaker.customSticker
...
class CustomImageView @JvmOverloads constructor(
    ...
    fun showBorder() {
        rootLayoutSticker.background =
            ContextCompat.getDrawable(context, R.drawable.my_border)
    }

    fun setImagePath(imagePath: String) {
        exactBitmap = Utils.scaleDown(Utils.getBitmapOrg(imagePath), 1080f, true)
        if (exactBitmap != null) {
            //this.imageView.alpha = 0.5f
            this.imageView.setImageBitmap(exactBitmap)
        }
    ...
    interface CustomImageCallBack {
        fun stickerViewClickDown(currentView: CustomImageView)
